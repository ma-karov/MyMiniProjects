                    ...
                    <form method="post" action="">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" name="startTime" required placeholder="Enter start Time">
                            </div>
                            <div class="form-group">
                                <label>End Time *</label>
                                <input type="time" class="form-control" name="endTime" required placeholder="End Time">
                            </div>
