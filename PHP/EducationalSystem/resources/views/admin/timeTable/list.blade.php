...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="col-sm-6">
            <h1>
                Time Table List (Total : {{$getRecord->total()}})

            </h1>
        </div>
        <!-- <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/timeTable/add') }}" class="btn btn-primary">Add new Time Table</a>
        </div> -->
    </section>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <a href="{{ url('admin/timeTable/list')}}" class="btn btn-success" type="submit" style="margin-top: 25px;">Reset</a>
                            ...
                            <table class="table table-striped responsive table-bordered" id="scheduleTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ date('H:i A', strtotime($value->startTime))}}</td>
                                        <td>{{ date('H:i A', strtotime($value->endTime))}}</td>
                                        <td>{{$value->group}}</td>
                                        <td>{{$value->room}}</td>
                                        <td>{{$value->day}}</td>
